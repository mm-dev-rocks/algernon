...
//List<TextSpan> spacedTextSpan({
//  required Iterable<TextSpan> children,
//  String spacer = ' ',
//}) => children
//    .expand((item) sync* {
...
//      DateTime(int.parse(yyyy), int.parse(mm), int.parse(dd)),
//    );
//  }
//  return [date, time];
//}
...
//    r'(, |- | -| - | ~ |\(|\)|\[|\]|mp3\b|\.opus|\.m4b\b|\.mp3\b|128k|64k|' +
//        tempDelimiter +
//        ')',
//    caseSensitive: false,
//  );
...
//  );
//
//  cleanedTitle = cleanedTitle.splitMapJoin(
//    splitterNumAtStart,
...
//
//  cleanedTitle = cleanedTitle.splitMapJoin(
//    splitterPartNumAtEnd2,
//    onMatch: (m) => '$tempDelimiter${m[0]!}',
//    onNonMatch: (n) => n,
//  );
//
...
String durationToMinutesAndSeconds(Duration duration) {
